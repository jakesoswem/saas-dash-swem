...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "billowing-tree-5f82-d1":

```bash
npx wrangler d1 create billowing-tree-5f82-d1
```
